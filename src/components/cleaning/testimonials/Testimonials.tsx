...
import { TestimonialCard } from '../../wood/testimonials/components/testimonial-card'
            ...
            {([-1, 1] as const).map((d, i) => (
              ...
              >
                <img
                  src={iconArrow}
                  alt=""
                  style={{ width: 18, filter: 'brightness(0) invert(1)', transform: d < 0 ? 'rotate(180deg)' : '' }}
                />
              </button>
            ))}
          </div>
          ...
          {items.map((_, i) => (
            <button
              ...
              style={{
                ...
                transition: 'width .3s var(--ease)', border: 'none', cursor: 'pointer',
              }}
            />
          ))}
        </div>
